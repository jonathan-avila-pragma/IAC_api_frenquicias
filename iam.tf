# Role para ECS Task Execution (permite a ECS ejecutar tareas)
...
# Política adicional para acceder a Secrets Manager (si se usa para credenciales)
...
# Role para ECS Task (permite a la aplicación acceder a otros servicios AWS)
...
# Role para API Gateway (si se necesita)
